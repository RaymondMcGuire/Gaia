 ...
 * Ton-That, Quoc-Minh, Paul G. Kry, and Sheldon Andrews. "Parallel block
 * Neo-Hookean XPBD using graph clustering." Computers & Graphics 110 (2023):
 * 1-10. Faster than MCS but results are inferior
 */
